...
STOP_PHRASES = (
    ...
    # фаза 4 (ISSUE_i18n «Запрещённые фразы»):
    "лучший вариант", "идеальн", "прекрасный вариант", "отлично подойдет", "не пожалеете", "великолепн", "ең жақсы таңдау", "ең жақсы нұсқа", "мінсіз", "тамаша нұсқа", "тамаша сай келеді", "өз ісінің шебері", "жоғары сапа", "жеке көзқарас", "жоғары деңгейде", "ұмытылмас", "өкінбейсіз", "іс-шараңызға тамаша", "excellent choice", "best choice", "best option", "perfect", "ideal", "great option", "true professional", "high quality", "individual approach", "top-notch", "won't regret",
)
