...
def test_budget_fit_curve():
    assert budget_fit(100, 1000) == 0.5
    assert budget_fit(350, 1000) == pytest.approx(0.75)
    assert budget_fit(700, 1000) == 1.0
    assert budget_fit(950, 1000) == pytest.approx(0.8)
    assert budget_fit(1000, 1000) == pytest.approx(0.6)
    assert budget_fit(1001, 1000) == 0.0
